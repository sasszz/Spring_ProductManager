    ...
    <div class="row">
        <div class="col d-flex flex-column align-items-center justify-content-center">
            <div class="card mt-5 text-center mb-3 p-3">
                <div class="card-body">
                    <h5 class="card-title title text-dark">Update Category</h5>
                    <form:form action="/categories/edit/${category.id}" method="post" modelAttribute="category">
                        ...
                        <input class="btn btn-outline-light w-50 title align-self-center" type="submit" value="Update"/>
                    </form:form>
                </div>
            </div>
        </div>
